(function (factory) {
    ...
    var DataStream = /** @class */ (function () {
        ...
        DataStream.prototype.writeStruct = function (structDefinition, struct, needConvertStructDef) {
            if (needConvertStructDef === void 0) { needConvertStructDef = false; }
        ...
        DataStream.defWriteStruct = function (readStructDef, struct) {
            ...
            var _loop_1 = function (i) {
                ...
                if (typeof t === "string" && /,.+:[A-Za-z_]/.test(t)) {
                    ...
                    t = tp[0];
                    var charset = tp[1];
                    var uint8Array_1 = new text_encoding_1.TextEncoder(charset).encode(struct[v]);
                    struct[len] = uint8Array_1.length;
                    ret.push(function (ds) { return ds.writeUint8Array(uint8Array_1); });
                }
                else {
